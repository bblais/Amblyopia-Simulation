...
![[Pasted image 20250416110214.png]]{#fig:dODI_contrast}
...
Metaplasticity a key to visual recovery from amblyopia in adulthood?   recent review where we re-examine what's known about conventional and new amblyopia therapies through the lens of metaplasticity. Perhaps this could be used in the background/discussion if not informative for study design.
Brief review of amblyopia development and your prior findings (cite previous paper).
