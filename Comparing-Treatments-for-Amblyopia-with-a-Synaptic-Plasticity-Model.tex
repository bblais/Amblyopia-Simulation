...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, coltitle=black, opacitybacktitle=0.6, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, left=2mm, toptitle=1mm, arc=.35mm, opacityback=0, bottomtitle=1mm, leftrule=.75mm, breakable, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white]
