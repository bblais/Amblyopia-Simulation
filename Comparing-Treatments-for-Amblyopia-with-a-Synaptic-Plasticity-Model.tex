...
{\centering \includegraphics{./Treatment Models_files/figure-pdf/fig-patch-inputs-output-1.png}
...
{\centering \includegraphics{./Treatment Models_files/figure-pdf/fig-contrast-modified-inputs-output-1.png}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, colback=white, breakable, rightrule=.15mm, coltitle=black, toptitle=1mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, bottomrule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm]
