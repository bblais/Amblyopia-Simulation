...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, toptitle=1mm, breakable, opacityback=0, colback=white, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, toprule=.15mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, arc=.35mm, leftrule=.75mm, rightrule=.15mm]
