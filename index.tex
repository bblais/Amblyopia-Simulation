...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colback=white, bottomtitle=1mm, coltitle=black, titlerule=0mm, colframe=quarto-callout-important-color-frame, leftrule=.75mm, opacitybacktitle=0.6, breakable, opacityback=0, left=2mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, rightrule=.15mm, bottomrule=.15mm]
