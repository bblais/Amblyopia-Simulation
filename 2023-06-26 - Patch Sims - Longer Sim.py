...
# ## Just do the patch for twice as long
# 
# this is to answer the question:  why not reverse amblyopia in the case of patch treatment?
...
def run_one_continuous_patch_jitter(params,
    ...
    seq+=patch_treatment_jitter(patch_noise=noise,
               total_time=16*day,number_of_neurons=params.number_of_neurons,
            mu_c=mu_c,sigma_c=sigma_c,
               eta=eta,
...
savefig('fig-patch-response-ODI-blur-long.png')    
